...
const PERSON_SECTIONS = [
  ...
  },
  {
    ...
    body: "Default: `zeroday operate` (keyless coding-agent path). Optional: `zeroday locate --live` when you host Antares-1B locally via completions. Fixture modes need no weights. Source never leaves the machine.",
  },
  {
    title: "CISO skim",
