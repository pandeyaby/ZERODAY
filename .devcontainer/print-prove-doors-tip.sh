...
════════════════════════════════════════════
  ...
  5. Optional: Run Task → “ZERODAY: gpu-evidence” (historical Measured A40 only; does not start RunPod)
...
Honest non-claims:
  ...
  · gpu-evidence task = historical Measured A40 only; does not start RunPod
